<div class="pl1 py2 rh-logo-sitename mx-auto" style="max-width: 1152px">
    <a href="{!! env('WP_HOME') !!}"><img src="/include/img/rh-logo.jpg" alt="Länk till förstasidan"></a>
</div>
<div style="background: #004890; color: white;">
    <div class="pl1 mx-auto pt3" style="padding-bottom: 5em; max-width: 1152px">
        <a href="{!! env('WP_HOME') !!}" style="text-decoration:none;"><h1 class="h1" style="display:inline; color:white;">
            Driftinformation
        </h1></a>
    </div>
</div>